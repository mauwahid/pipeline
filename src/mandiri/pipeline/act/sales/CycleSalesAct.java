package mandiri.pipeline.act.sales;
...
public class CycleSalesAct extends GenericForwardComposer<Component> implements Act<CycleSales>{
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		loadData();
		userSales = (UserSales) session.getAttribute("pengguna");
	}
	...
	public void loadData() {
		// TODO Auto-generated method stub
			...
			List<CycleSales> list = cycleSalesDao.getAsUserSales(userSales);
	...
	public void showForm(CycleSales entity) {
		...
		btnSave.addEventListener("onClick", new EventListener<Event>() {
			...
			public void onEvent(Event event) throws Exception {
				...
				logSales.setUserSales(userSales.getUsername());
				logSales.setTglperubahanAkhir(new Date().toLocaleString());
