...
public class ProductAct extends GenericForwardComposer<Component> implements Act<Product> {
	...
	public void loadData() {
		...
		//	listModel = new SimpleListModel<DistributionFinance>(list);
			...
			list_product.setItemRenderer(new ProductRenderer());
			list_product.renderAll();
			//setCheckBox();
			
			
	}
	
	class ProductRenderer implements ListitemRenderer<Product>{

		
		@Override
		public void render(Listitem item, Product entity, int index)
				throws Exception {
			// TODO Auto-generated method stub
			final Product dataTemp = entity;
			index = index + 1;
	...
	@Override
	public void showForm(Product entity) {
		// TODO Auto-generated method stub
		if(entity!=null)
			product = entity;
		...
		tbNama = new Textbox(product!=null?product.getNama():"");
	...
	private void deleteData(Product dataTemp) {
		// TODO Auto-generated method stub
		productDao = HibernateUtil.getProductDao();
		productDao.delete(dataTemp);
