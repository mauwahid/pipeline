...
public class UserSolutionAct extends GenericForwardComposer<Component> implements Act<UserSolution> {
	...
	public void showForm(UserSolution entity) {
		...
		tbUsername = new Textbox(userSolution!=null?userSolution.getUsername():"");
		...
		tbPassword = new Textbox(userSolution!=null?userSolution.getPassword():"");
